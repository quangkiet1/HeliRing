...
function Ring3DFallback() {
  return (
    <div className="relative z-10 mx-auto flex h-[22rem] w-full max-w-[38rem] items-center justify-center md:h-[30rem] lg:h-[36rem]">
      ...
      <div className="relative h-48 w-48 animate-[spin_12s_linear_infinite] rounded-full border-[26px] border-slate-300/80 bg-transparent shadow-[inset_18px_0_30px_rgba(255,255,255,0.9),inset_-18px_0_26px_rgba(15,23,42,0.12),0_34px_90px_rgba(16,185,129,0.22)] dark:border-slate-500/70 md:h-64 md:w-64 md:border-[34px]">
...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-[92vh] flex items-center pt-24 md:pt-36 pb-16 overflow-hidden bg-white dark:bg-slate-950 transition-colors duration-500">
      ...
      <div className="absolute top-1/4 right-0 w-[500px] h-[500px] bg-gradient-to-tr from-emerald-500/10 to-sky-400/5 rounded-full blur-[140px] pointer-events-none" />
      <div className="absolute bottom-1/4 left-1/10 w-[350px] h-[350px] bg-emerald-500/5 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 w-full">
        <div className="grid grid-cols-1 gap-8 sm:gap-10 lg:grid-cols-12 lg:gap-16 items-center">
          ...
          <div className="order-2 flex flex-col items-start lg:order-none lg:col-span-7">
            
            {/* Dynamic Intro Tag */}
            <div 
              className="inline-flex animate-fade-in items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-100 text-emerald-800 dark:bg-emerald-950/40 dark:text-emerald-300 text-xs font-bold uppercase tracking-wider mb-6"
            >
            ...
            <h1 
              className="animate-fade-in text-5xl md:text-[5.5rem] font-black text-slate-900 dark:text-white leading-[0.9] tracking-tight mb-6 uppercase"
            ...
            <p 
              className="animate-fade-in text-lg md:text-xl text-slate-600 dark:text-slate-300 font-medium leading-relaxed max-w-xl mb-8 pr-14 sm:pr-0"
            ...
            <div 
              className="animate-fade-in grid grid-cols-2 gap-4 w-full max-w-lg mb-10"
            ...
            {/* CTAs */}
            <div 
              className="animate-fade-in flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full"
          ...
          <div className="order-1 relative flex items-center justify-center lg:order-none lg:col-span-5">
            <div 
              className="relative z-10 flex min-h-[19rem] w-full max-w-[32rem] animate-fade-in items-center justify-center md:min-h-[32rem] md:max-w-[38rem] lg:min-h-[38rem]"
            ...
            >
              {shouldLoadRing ? (
                ...
                <>
                  ...
                  <button
                    type="button"
                    onClick={() => setShouldLoadRing(true)}
                    className="absolute bottom-4 left-1/2 z-30 -translate-x-1/2 rounded-full border border-emerald-200 bg-white/90 px-4 py-2 text-xs font-black uppercase tracking-wide text-emerald-700 shadow-sm backdrop-blur transition hover:-translate-y-0.5 hover:bg-emerald-50 dark:border-emerald-300/20 dark:bg-slate-950/80 dark:text-emerald-300 dark:hover:bg-slate-900 md:bottom-8"
                  >
                    Xem 3D
                  </button>
                </>
      ...
      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1.5 text-slate-400 pointer-events-none">
        ...
        <div className="w-5 h-9 rounded-full border-2 border-slate-300 dark:border-slate-700 flex justify-center p-1">
          <div className="w-1 h-2 rounded-full bg-emerald-500 animate-scroll-down" />
        </div>
      </div>
